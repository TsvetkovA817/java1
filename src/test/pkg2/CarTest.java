...
public class CarTest {
    ...
    public void before() throws Exception {
        car = new Car("company1", "model1", 2023);
    }
    ...
    public void testInstanceOf() throws Exception {
        assertNotNull("Нет значения", car);
    ...
    public void testGetYearRelease() throws Exception {
        int zn = car.getYearRelease();
        int ex = 2023;

        int[] arrYears = {0, 0, 0, 0};
        arrYears[0] = 2020;
        arrYears[1] = 2021;
        arrYears[2] = 2022;
        arrYears[3] = 2023;
    ...
    /**
     * Method: testToString()
     * Тест представления объкта:
     * Должна быть строка, не нулевая, равна указанной
     */
    @Test
    public void testToString() throws Exception {
        String zn = car.toString();
        String ex = "This car is a 2023 company1 model1;";
